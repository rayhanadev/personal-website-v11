...
import aidenBaiImage from "@/assets/images/blog/reverse-engineering-yc/aiden-bai.png";
import finalImage from "@/assets/images/blog/reverse-engineering-yc/final.png";
import networkRequestsImage from "@/assets/images/blog/reverse-engineering-yc/network-requests.png";
import paramsImage from "@/assets/images/blog/reverse-engineering-yc/params.png";
...
<Figure
  alt="Chrome DevTools Network panel showing requests from Work at a Startup"
  caption="Opening up the Networking tab in Chrome DevTools reveals some good information!"
  src={networkRequestsImage}
/>
...
<Figure
  alt="Algolia request parameters shown in Chrome DevTools"
  caption="Neat, some more helpful information!"
  src={paramsImage}
/>
...
const { hits } = await client.searchSingleIndex({
  ...
  searchParams: {
    ...
    hitsPerPage: 100,
    page: 0,
    filters: ["role:eng", 'locations_for_search:"San Francisco, CA, US"', 'job_type:"intern"'].join(
      " AND ",
    ),
...
<Figure
  alt="Work at a Startup company response details in Chrome DevTools"
  caption="It's the Million.js and React Scan man!"
  src={aidenBaiImage}
/>
...
<meta
  name="csrf-token"
  content="MpJIX7UqDYpjEzLS3UsMOd54yHQtEP917GGJb9CDGZMK9LLTaOgS9qhtoWW2ueiqu_47uImkE2jBbd6PF9m1YQ"
/>
```
...
<Figure
  alt="Terminal output showing enriched YC internship leads"
  caption="Much useful, very work."
  src={finalImage}
/>
